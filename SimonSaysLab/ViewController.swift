...
class ViewController: UIViewController {
    ...
    @IBAction func redGuess(sender: AnyObject) {
    ...
    @IBAction func greenGuess(sender: AnyObject) {
    ...
    @IBAction func yellowGuess(sender: AnyObject) {
    ...
    @IBAction func blueGuess(sender: AnyObject) {
